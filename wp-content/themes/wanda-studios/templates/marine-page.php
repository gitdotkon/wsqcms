    ...
    while(have_posts()){
        ...
        if($section){
            ...
            foreach ($section as $item){
                ...
                // Description detail
                show_template('marine/description-detail', array('section' => $item));
                show_template('marine/way-section', array('section' => $item));
                show_template('marine/image-features', array('section' => $item));
                echo '</div>';
            }
            echo '</div>';
        }
