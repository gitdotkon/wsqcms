...
<script>
    ...
    function baidumap() {
        ...
        map.centerAndZoom(new BMap.Point(lat, lng), 18);  // 初始化地图,设置中心点坐标和地图级别
        ...
        var icon = new BMap.Icon("images/marker.png", new BMap.Size(88, 96));
    ...
    (function($){
        $(document).ready(function(){
            ...
            include("https://maps.googleapis.com/maps/api/js?key=AIzaSyCin9QXmBpNwyHHF1U0vPeGCwOkiPc0n8I&callback=startGoogle");
