...
class Walker_Nav_Menu_Edit_Custom extends Walker_Nav_Menu
{
    ...
    function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
    {
        ...
        $icon_arr = customIconsList::$icon_arr;
        ?>
        ...
        <div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo $item_id; ?>">
            ...
            <div class="description description-wide ">
                <div class="menu-icon-wrapper">
                    <span class="<?php echo $item->custom?:'' ?>" style="  "></span>
                    <label for="edit-menu-item-custom-<?php echo $item_id; ?>">
                        <?php _e('Menu icon'); ?><br/>

                        <select class="menu-wanda-icon widefat code edit-menu-item-custom" name="menu-item-custom[<?php echo $item_id; ?>]"
                                id="edit-menu-item-custom-<?php echo $item_id; ?>">
                            <option value=""><?php _('Please select...'); ?></option>
                            <?php foreach ($icon_arr as $key => $icon): ?>
                                <option
                                    value="<?php echo $key; ?>" <?php selected($item->custom, $key); ?>><?php echo $icon; ?>
                                    - <?php echo $key; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </label>
