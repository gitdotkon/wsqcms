        ...
        <div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
            ...
            <p class="field-custom description description-wide">
                <label for="edit-menu-item-custom-<?php echo $item_id; ?>">
                    <?php _e( 'Custom' ); ?><br />
                    <select class="widefat code edit-menu-item-custom" name="menu-item-custom[<?php echo $item_id; ?>]" id="edit-menu-item-custom-<?php echo $item_id; ?>">
                        <?php foreach ($icon_arr as $key => $icon): ?>
                            <option value="<?php echo $key; ?>" <?php selected($item->custom, $key); ?>><?php echo $icon; ?> - <?php echo $key; ?></option>
                        <?php endforeach; ?>
                    </select>
                </label>
            </p>
